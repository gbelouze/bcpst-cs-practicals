...
\begin{figure}[h!]
    \begin{center}
        \subfloat[une image grise]{
            \includegraphics[width=0.45\textwidth]{figures/poivrons_grey.png}
        }
        \subfloat[zoom sur le carré rouge]{
            \includegraphics[width=0.45\textwidth]{figures/poivrons_window_grey.png}
        }
    \end{center}
...
\begin{figure}[!h]
    \begin{center}
        \subfloat[Image mirroir]{
            \includegraphics[width=0.3\textwidth]{figures/mirror.png}
        }
        \subfloat[Image en négatif]{
            \includegraphics[width=0.3\textwidth]{figures/negatif.png}
        }
        \subfloat[Moitié gauche]{
            \includegraphics[width=0.15\textwidth]{figures/left_half.png}
        }
    \end{center}
...
\begin{figure}[h!]
    \begin{center}
        \subfloat[Image éclaircie]{
            ...
            \includegraphics[width=0.4\textwidth]{figures/eclairci.png}
        }
        \subfloat[Image assombrie]{
            \label{fig:img-assombrie}
            \includegraphics[width=0.4\textwidth]{figures/noirci.png}
        }
    \end{center}
...
\begin{figure}[h!]
    \begin{center}
        \subfloat[Image contrastée]{
            ...
            \includegraphics[width=0.4\textwidth]{figures/contrasted.png}
        }
        \subfloat[Image peu contrastée]{
            \label{fig:img-low-contrast}
            \includegraphics[width=0.4\textwidth]{figures/less_contrasted.png}
        }
    \end{center}
